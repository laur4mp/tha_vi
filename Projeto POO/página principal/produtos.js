function Layout(){
    window.location.href = 'pagina-principal.html'; //função para o botão de página principal
}
...
//mensagem pronta que é enviada com o pedido
    const mensagem = `Olá, gostaria de personalizar uma peça. /n/nNome: ${nome} /nDescrição: ${descricao} /nTelefone: ${telefone}`;
